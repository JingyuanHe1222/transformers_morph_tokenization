...
try:
    ...
    _import_structure["models.llama_morph"].append("LlamaMorphTokenizer") ###
...
try:
    ...
    _import_structure["models.llama_morph"].append("LlamaMorphTokenizerFast")
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .models.llama import LlamaTokenizer, LlamaMorphTokenizer
        # from .models.llama_morph import LlamaMorphTokenizer ###
    ...
    try:
        ...
        from .models.llama import LlamaMorphTokenizerFast
